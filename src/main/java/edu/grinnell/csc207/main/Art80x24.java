...
public class Art80x24 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    AsciiBlock starStripes = new VComp(HAlignment.CENTER, new AsciiBlock[] {redStarLine,whiteStarLine,redStarLine});
    AsciiBlock starLine = new HComp(VAlignment.TOP, new AsciiBlock[] {flagCorner,starStripes});
    AsciiBlock lineBlock = new VComp(HAlignment.CENTER, new AsciiBlock[] {fullWhiteStarLine,fullRedStarLine,fullWhiteStarLine,fullRedStarLine,fullWhiteStarLine});
